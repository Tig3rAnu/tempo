...
export function MedicalCourseForm() {
  const {
    control,
    register,
    watch,
      ...
      <div className="flex mb-4 w-full flex-wrap">
        <div className="w-full">
          ...
          <div className="flex justify-between items-center max-[991px]:flex-wrap">
            ...
            <div className="w-1/3 pr-4 max-[991px]:w-full max-[991px]:pr-0 max-[991px]:mb-4">
      ...
      <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
        ...
        {isMasters && (
          <div className="flex mb-4 w-full flex-wrap">
            ...
            <div className="flex w-full flex-wrap">
              <div className="w-1/3 mb-4 pr-4 max-[991px]:w-1/2 max-[575px]:w-full8">
                <Label className="mb-2 inline-block">
